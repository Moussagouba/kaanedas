<x-app-layout>
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="w-full md:w-1/2 py-24 mx-auto">
            ...
            @endif
            <form action="{{ route('listings.store') }}" id="payment_form" method="post" enctype="multipart/form-data" class="bg-gray-100 p-4">
                @guest
                <div class="flex mb-4">
                ...
                <div class="mb-4 mx-2">
                    ...
                    <x-input id="apply_link" class="block mt-1 w-full" type="text" name="lien" required />
                </div>
                <div class="mb-4 mx-2">
                ...
                <div class="mb-4 mx-2">
                    <label for="tres_recherche" class="inline-flex items-center font-medium text-sm text-gray-700">
                        <input type="checkbox" id="tres_recherche" name="tres_recherche" value="Yes" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-offset-0 focus:ring-indigo-200 focus:ring-opacity-50">
                        <span class="ml-2">Highlight this post (extra $2)</span>
                    </label>
                </div>
                <div class="mb-6 mx-2">
