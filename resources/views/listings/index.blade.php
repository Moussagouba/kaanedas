<x-app-layout>
    ...
    <x-hero></x-hero>
    <section class="container px-5 py-12 bg-gray-100 mx-auto">
        <div class="mb-12">
        ...
        <div class="py-12">
            <div class="container-fluid m-auto px-6 text-gray-600 md:px-12 xl:px-6">
                ...
                <div class="lg:w-3/4 bg-dark lg:mx-auto">
                    ...
                    <a href="{{ route('listings.show', $listing->slug) }}" class="group relative -mx-4 sm:-mx-8 p-6 sm:p-8 rounded-3xl bg-white dark:bg-transparent border border-transparent hover:border-gray-100 dark:shadow-none dark:hover:border-gray-700 dark:hover:bg-gray-800 shadow-2xl shadow-transparent hover:shadow-gray-600/10 sm:gap-8 sm:flex transition duration-300 hover:z-10">
                        <div class="sm:w-2/6 rounded-3xl overflow-hidden transition-all duration-500 group-hover:rounded-xl">
                            ...
                            <div class="sm:w-2/6  overflow-hidden transition-all duration-500 group-hover:rounded-xl">
                        ...
                        <div class="md:w-1/2 mr-8 flex flex-col items-start justify-center">
                            <h2 class="text-xl font-bold text-blue-500 title-font mb-1">{{ $listing->title }}</h2>
                            <p class="leading-relaxed text-gray-900">
                                {{ $listing->company }} &mdash; <span class="text-red-600">{{ $listing->location }}</span>
                            </p>
                        </div>
                        ...
                        <span class="md:flex-grow flex items-center justify-end">
                            <span class="text-blue-100">{{ $listing->created_at->diffForHumans() }}</span>
                        </span>
                    </a>
                    <br>
                    @endforeach
